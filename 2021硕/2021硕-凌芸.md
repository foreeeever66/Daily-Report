...
* <font size=4>__*14:30-17:30：*__</font>
    >在web of science 调研复杂系统目前方向
* <font size=4>__*19:00-22:30：*__</font>
    > 读一篇长综述《Modeling Complex Systems by Structural Invariants Approach》
* <font size=4>__*收获*__</font>
    >1.许多方法已被用于对复杂系统进行建模:多智能体和元胞自动机方法,物理方法,概率和统计方法,状态方法,复杂性和熵方法 ,结构不变方法,仿真方法 。
  2.劳克林引入了"作为组织原理的涌现"，并从这个角度探索了广泛的物理学领域。整本书引出了以下观点："如果我们接受世界涌现，我们也宣布了还原论的终结。（也就是说，当我们认为世界上所有必需品都可以计算出来的时候，时间的尽头。这意味着，在研究这些系统时，总有一部分事件我们无法计算。
