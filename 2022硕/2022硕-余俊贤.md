...
> <font size=4>听了一篇慢速英语和一篇常速英语，并整理词汇；复习前几天记录单词的读音与拼写。
* <font size=4>__*下午：*__</font>
>看完《fPINNs:FRACTIONAL PHYSICS-INFORMED NEURAL NETWORK》剩余部分。
* <font size=4>__*晚上：*__</font>
>整理fPINNs重点；整理师兄发的有限元学习资料；制作汇报PPT。
* <font size=4>__*收获*__</font>
>1、英语听力学习效率不高、提升比较缓慢，打算之后每天只听一篇，听到能边听边写为止。

>2、今天在粗看有限元知识的时候发现很多之前看着很奇怪的英文词汇对应的中文都出现了，很期待有了有限元的知识，我的思维结构会发生什么样的变化。

#  2021.12.8
* <font size=4>__*上午：*__</font>
> <font size=4>写完文献综述参考文献与摘要部分；构思课程汇报PPT。
* <font size=4>__*下午：*__</font>
>健身；补交校长奖学金材料。
* <font size=4>__*晚上：*__</font>
>看到《fPINNs:FRACTIONAL PHYSICS-INFORMED NEURAL NETWORK》的第八页；文献综述排版。
* <font size=4>__*收获*__</font>
>fPINNs将偏微分问题分成了两类：前向问题：分数阶已知、方程参数已知、初始边界条件已知，使用定义域内训练点完成训练获得方程解；反向问题：仅初始边界条件已知、再加上最终时刻测量的标签数据，求解分数阶、方程参数以及方程解。

#  2021.12.7
* <font size=4>__*上午：*__</font>
> <font size=4>写完文献综述PINNs的原理部分。
* <font size=4>__*下午：*__</font>
>看《fPINNs:FRACTIONAL PHYSICS-INFORMED NEURAL NETWORK》的摘要与引言部分；学习分数阶微分算法GL公式。
* <font size=4>__*晚上：*__</font>
>构思文献综述PINNs发展与应用：国外发展、国内应用，PINNs在电气工程中使用展望，总结三部分；完成三部分内容的写作。
* <font size=4>__*收获*__</font>
>写论文还是需要很多积累，对工具的使用也要很熟练，明天完成参考文献与摘要部分的撰写。
